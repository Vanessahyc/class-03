...
export default function ExampleFour() {
    ...
    //setNumber is used to update the useState, always use camelcase
    var [number, setNumber] = useState(0);//initially start as the number 0
    ...
    return(
        <>
            ...
            <main>
                ...
                {
                    number > 1 && <div style={{
                        backgroundColor: `${color}`,//do this inline style for api, always!!!
                        lineHeight: 10,
                        padding: 20
                    }}>
                        Box
